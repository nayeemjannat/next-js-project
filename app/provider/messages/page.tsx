...
export default function ProviderMessagesPage() {
  ...
  const conversations = [
    {
      id: 1,
      name: "Emily Carter",
      lastMessage: "Can you come on Saturday instead?",
      unread: false,
    ...
    },
    {
      ...
      lastMessage: "Thank you for the great job!",
      unread: false,
  ...
  const messages = [
    { id: 1, sender: "customer", text: "Can you come on Saturday instead?", time: "10:30 AM" },
    { id: 2, sender: "provider", text: "Sure, I can adjust my schedule.", time: "10:32 AM" },
    { id: 3, sender: "customer", text: "Perfect! See you Saturday at 2 PM", time: "10:35 AM" },
  ]
                ...
                {messages.map((msg) => (
                  <div key={msg.id} className={`flex ${msg.sender === "provider" ? "justify-end" : "justify-start"}`}>
                    ...
                    >
                      ...
                      <p
                        className={`text-xs mt-1 ${msg.sender === "provider" ? "text-primary-foreground/70" : "text-muted-foreground"}`}
                      >
                        {msg.time}
                      </p>
                    </div>
